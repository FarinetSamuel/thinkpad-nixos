...

{
  ...
  networking.firewall = {
    ...
    # Réduire les règles à l'essentiel
    allowedTCPPorts = lib.mkForce [ 5678 ]; # Uniquement pour n8n (port 5678)
  ...
  # 7. Optimisation Bluetooth (344ms)
  hardware.bluetooth = {
    enable = true;
    # Démarrer le service uniquement lorsque nécessaire
    powerOnBoot = false;
  };
